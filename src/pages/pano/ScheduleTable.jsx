...
export function ScheduleTableList() {
    ...
    function handleEditable(e) {
        ...
        if (e.target.name == "cancel") {
            ...
            // Kontrol edilirken sıkıntı olup olmadığını anlamak için setTimeOut 500ms eklendi
            setTimeout(() => {
    ...
    return (<>
        ...
        <div className="insideclass schedule-page bg-[#FEFEFE] border-2 drop-shadow-lg m-auto h-auto flex flex-col justify-center gap-4 p-4 h-full">
            {isEditable ? <> <Button
