...
const MultipleChoiceSurvey = (props) => {
  ...
  const handleValueSelect = (value) => {
    ...
    console.log("MultipleChoice - Seçilen Değer:", value, "Soru oid:", multipleQuestionOid);
  };
      ...
      <div className='overflow-x-auto px-4 py-2 overflow-y-auto max-w-[46vh] max-h-[22vh]  p-1 min-w-[46vh] min-h-[22vh] mt-0.5'>
        {multipleOptions.map((option, index) => (
          <div key={index} className="flex items-center py-1">
           ...
           <input
               type="radio"
               onClick={() => handleValueSelect(option)}  /// value->option (option değerini doğrudan handleValueSelect fonksiyonuna geçir)........A
